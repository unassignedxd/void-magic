package com.unassigned.voidmagic.datagen.providers;
...
public abstract class CustomLootTableProvider extends LootTableProvider {
    ...
    public CustomLootTableProvider(DataGenerator dataGeneratorIn) {
